...
<html>
<head>
<title>Website  | Contact :: Bijay and Mahesh</title>
		...
		<div class="content-top">
				  ...
				  <div class="contact-form">
				  	<h3>Contact Us</h3>
					    <form action="process_contact.php" method="post" name="form11">
					    	<div>
						    	<span><label>NAME</label>Mahesh and Bijay</span>
						    	<span><input type="text" value="" required name="name"></span>
						    </div>
						    <div>
						    	<span><label>E-MAIL</label>bijay@gmail.com</span>
						    	<span><input type="text" value="" required name="email"></span>
						    </div>
						    <div>
						     	<span><label>MOBILE.NO</label>981234566</span>
				...
				<div class="col span_1_of_3">
      			...
      			<div class="company_address">
						...
						<p>Phone:(00)666666</p>
				   		<p>Fax: (000) 0</p>
				 	 	<p>Email: <span>mahesh.company.com</span></p>
...
<div class="footer">
	...
	<div class="wrap">
	<div class="copy">
		<p>All rights Reserved | Design by Mahesh and Bijay</p>
	</div>
 	</div>
</div>
</body>
